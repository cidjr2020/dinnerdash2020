...
#
  ...
  {name: 'Fetuccine', description:" A deliciosa massa italiana", available: true, price: 15, meal_category_id: 1 },
  {name: 'Arroz com feijão', description:"Mais gostoso que a farofa normal", available: true, price: 15, meal_category_id: 1 },
